...
/**@fn begin
   ...
   @return true if sensor is correctly connected, false if not
*/
bool BME280::begin(uint8_t sda, uint8_t scl)
{
  // Wire begin
  Wire.begin(sda, scl);
  // check if sensor is connected, if not try the alternative address
...
float BME280::readHumidity()
{
  ...
  var1 = (((((adc_H << 14) - (((int32_t)compensation.dig_H4) << 20) - (((int32_t)compensation.dig_H5) * var1)) + ((int32_t)16384)) >> 15) * (((((((var1 * ((int32_t)compensation.dig_H6)) >> 10) * (((var1 * ((int32_t)compensation.dig_H3)) >> 11) + ((int32_t)32768))) >> 10) + ((int32_t)2097152)) * ((int32_t)compensation.dig_H2) + 8192) >> 14));
